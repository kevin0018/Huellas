    ...
    const pets = await Promise.all([
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog1.jpg',
                sex: 'female',
                has_passport: true,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog2.jpg',
                sex: 'male',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog3.jpg',
                sex: 'male',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/ferret1.jpg',
                sex: 'female',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/cat1.jpg',
                sex: 'female',
                has_passport: true,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/cat2.jpg',
                sex: 'female',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog4.jpg',
                sex: 'male',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/cat3.jpg',
                sex: 'female',
                has_passport: true,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog5.jpg',
                sex: 'male',
                has_passport: true,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog6.jpg',
                sex: 'male',
                has_passport: true,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog7.jpg',
                sex: 'female',
                has_passport: true,
                country_of_origin: 'Spain',
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/cat4.jpg',
                sex: 'male',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/ferret2.jpg',
                sex: 'male',
                has_passport: false,
        ...
        prisma.pet.create({
            data: {
                ...
                profile_image_url: '/pets/dog8.jpg',
                sex: 'female',
                has_passport: true,
